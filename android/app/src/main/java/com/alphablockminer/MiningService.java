...
import com.alphablockminer.data.serialization.XMRigFork;
import com.alphablockminer.events.MinerStartEvent;
import com.alphablockminer.events.MinerStopEvent;
import com.alphablockminer.events.StdoutEvent;
import com.alphablockminer.utils.ProcessExitDetector;
...
public class MiningService extends Service {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.alphablockminer.service";
    private static final String NOTIFICATION_CHANNEL_NAME = "AlphaBlock Miner Service";
    ...
    public void onCreate() {
        ...
        notificationbuilder =
                new Notification.Builder(this, NOTIFICATION_CHANNEL_ID)
                        .setContentTitle("AlphaBlock Miner")
                        .setContentText("AlphaBlock Miner running")
                        .setSmallIcon(R.mipmap.ic_launcher)
                        .setContentIntent(pendingIntent)
                        .setTicker("AlphaBlock Miner running")
                        .setOngoing(true)
    ...
    public void startMining(String configPath, String xmrigFork) {
        ...
        // AlphaBlock only uses original XMRig (rx/0 algorithm)
        String xmrigBin = "libxmrig.so";
