...
import com.alphablockminer.data.serialization.Configuration
import com.alphablockminer.utils.XMRigConfigBuilder
...
import com.alphablockminer.events.*
import com.alphablockminer.services.IXMRigAPIService
import com.alphablockminer.services.ThermalService
import com.alphablockminer.services.XMRigAPIService
import com.alphablockminer.utils.CPUTemperatureHelper
    ...
    private val serverConnection = object: ServiceConnection {
        override fun onServiceConnected(className: ComponentName?, service: IBinder?) {
            ...
            when(className?.className) {
                "com.alphablockminer.MiningService" -> {
                    miningService = IMiningService.Stub.asInterface(service)
                }
                "com.alphablockminer.services.XMRigAPIService" -> {
